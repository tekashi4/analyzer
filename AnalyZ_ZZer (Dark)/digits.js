...
str=["R_100","R_10","R_25","R_50","R_75","RDBEAR","RDBULL","1HZ100V","1HZ10V","1HZ25V","1HZ50V","1HZ75V"];HdClss=[]; dps=[]; time=[0]; spot=[0]; tic=[]; digit=[0]; mType="none"; mColor="#32cd32"; mColorDigit="#32cd32"; lng="EN"; xVal=0; yVal=0; x=0; GraphLen= 10; checkBack = 0; cnt=20; tic=[];lColor=0;
