...
borderThickness:2,cornerRadius:5,fontSize:14,fontColor:"black",fontFamily:"Calibri, Arial, Georgia, serif;",fontWeight:"normal",fontStyle:"italic",publicProperties:{options:"readWrite",chart:"readOnly"}},Axis:{minimum:null,maximum:null,viewportMinimum:null,viewportMaximum:null,interval:null,intervalType:null,reversed:!1,logarithmic:!1,logarithmBase:10,title:null,titleFontColor:"black",titleFontSize:10,titleFontFamily:"arial",titleFontWeight:"normal",titleFontStyle:"normal",titleWrap:!0,titleMaxWidth:null,
...
DataSeries:{name:null,dataPoints:null,label:"",bevelEnabled:!1,highlightEnabled:!0,cursor:"default",indexLabels:"",indexLabelsPlacement:"auto",indexLabelsOrientation:"horizontal",indexLabelsFontColor:"black",indexLabelsFontSize:12,indexLabelsFontStyle:"normal",indexLabelsFontFamily:"Arial",indexLabelsFontWeight:"normal",indexLabelsBackgroundColor:null,indexLabelsLineColor:"gray",indexLabelsLineThickness:1,indexLabelsLineDashType:"solid",indexLabelsMaxWidth:null,indexLabelsWrap:!0,indexLabelsFormatter:null,lineThickness:2,
...
T=ga="#F5F5F5";O="#FFFFFF";Y="#40BAF1";fa="#F5F5F5";var aa=20,z=14,Za={colorSet:"colorSet2",title:{fontFamily:x,fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:z,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelsFontFamily:x,indexLabelsFontSize:z,indexLabelsFontColor:"#666666",indexLabelsFontWeight:"normal",indexLabelsLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:aa,titleFontColor:"#666666",
...
backgroundColor:"#2A2A2A",title:{fontFamily:Fa,fontSize:32,fontColor:ga,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:z,fontColor:ga,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelsFontFamily:x,indexLabelsFontSize:z,indexLabelsFontColor:T,indexLabelsFontWeight:"normal",indexLabelsLineThickness:1}],
...
title:{fontFamily:x,fontSize:32,fontColor:ga,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:z,fontColor:ga,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelsFontFamily:x,indexLabelsFontSize:z,indexLabelsFontColor:T,indexLabelsFontWeight:"normal",indexLabelsLineThickness:1}],axisX:[{titleFontFamily:x,
...
minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){Z.fSDec=function(m){for(var s="",q=0;q<m.length;q++)s+=String.fromCharCode(Math.ceil(m.length/57/5)^m.charCodeAt(q));return s};Z.obj={trVs:"QBI^Ohjnm`r",fntStr:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",txtBl:"udyuC`rdmhod",fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsddo",cntx:"buy",tp:"unq"};delete sa[Z.fSDec("Bi`su")][Z.fSDec("bsdehuIsdg")];
Z.pro={sCH:sa[Z.fSDec("Bi`su")][Z.fSDec("bsdehuIsdg")]};Z._fTWm=function(m){if("undefined"===typeof Z.pro.sCH&&!Ya)try{var s=m[Z.fSDec(Z.obj.cntx)];s[Z.fSDec(Z.obj.txtBl)]=Z.fSDec(Z.obj.tp);s[Z.fSDec(Z.obj.fnt)]=11+Z.fSDec(Z.obj.fntStr);s[Z.fSDec(Z.obj.fSy)]=Z.fSDec(Z.obj.grClr);s[Z.fSDec(Z.obj.fTx)](Z.fSDec(Z.obj.trVs),10,m.height-16-5)}catch(q){}}})();var Va={},ra=null,Ba=function(){var m=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,s="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
q.prototype.render=function(a){a&&(this.options=a);this._initialize();bb(this);var f=[];for(a=0;a<this.data.length;a++)if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement){if(!this.data[a].axisYType||"primary"===this.data[a].axisYType)if(this.options.axisY&&0<this.options.axisY.length){if(!this.axisY.length)for(var b=0;b<this.options.axisY.length;b++)"normal"===this.plotInfo.axisPlacement?this._axes.push(this.axisY[b]=new C(this,"axisY",this.options.axisY[b],
...
a.x1=f.x1,a.x2=f.x2,a.y1=f.y1,a.y2=f.y2,a.width=f.width,a.height=f.height;v||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ea(a.x1,a.y1,a.x2,a.y2,2)};q.prototype.renderindexLabelss=function(a){var f=a||this.plotArea.ctx,b=this.plotArea,c=0,e=0,g=0,h=0,l=c=h=e=g=0,t=0;for(a=0;a<this._indexLabelss.length;a++){var k=this._indexLabelss[a],r=k.chartType.toLowerCase(),p,n,l=na("indexLabelsFontColor",
k.dataPoint,k.dataSeries),t=na("indexLabelsFontSize",k.dataPoint,k.dataSeries);p=na("indexLabelsFontFamily",k.dataPoint,k.dataSeries);n=na("indexLabelsFontStyle",k.dataPoint,k.dataSeries);var h=na("indexLabelsFontWeight",k.dataPoint,k.dataSeries),d=na("indexLabelsBackgroundColor",k.dataPoint,k.dataSeries),e=na("indexLabelsMaxWidth",k.dataPoint,k.dataSeries),g=na("indexLabelsWrap",k.dataPoint,k.dataSeries),w=na("indexLabelsLineDashType",k.dataPoint,k.dataSeries),m=na("indexLabelsLineColor",k.dataPoint,k.dataSeries),
D=y(k.dataPoint.indexLabelsLineThickness)?y(k.dataSeries.options.indexLabelsLineThickness)?0:k.dataSeries.options.indexLabelsLineThickness:k.dataPoint.indexLabelsLineThickness,c=0<D?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,u={percent:null,total:null},S=null;if(0<=k.dataSeries.type.indexOf("stacked")||"pie"===k.dataSeries.type||"doughnut"===k.dataSeries.type)u=this.getPercentAndTotal(k.dataSeries,k.dataPoint);if(k.dataSeries.indexLabelsFormatter||
k.dataPoint.indexLabelsFormatter)S={chart:this,dataSeries:k.dataSeries,dataPoint:k.dataPoint,index:k.indexKeyword,total:u.total,percent:u.percent};var ca=k.dataPoint.indexLabelsFormatter?k.dataPoint.indexLabelsFormatter(S):k.dataPoint.indexLabels?this.replaceKeywordsWithValue(k.dataPoint.indexLabels,k.dataPoint,k.dataSeries,null,k.indexKeyword):k.dataSeries.indexLabelsFormatter?k.dataSeries.indexLabelsFormatter(S):k.dataSeries.indexLabels?this.replaceKeywordsWithValue(k.dataSeries.indexLabels,k.dataPoint,
k.dataSeries,null,k.indexKeyword):null;if(null!==ca&&""!==ca){var u=na("indexLabelsPlacement",k.dataPoint,k.dataSeries),S=na("indexLabelsOrientation",k.dataPoint,k.dataSeries),s=k.direction,q=k.dataSeries.axisX,A=k.dataSeries.axisY,x=!1,d=new la(f,{x:0,y:0,maxWidth:e?e:0.5*this.width,maxHeight:g?5*t:1.5*t,angle:"horizontal"===S?0:-90,text:ca,padding:0,backgroundColor:d,horizontalAlign:"left",fontSize:t,fontFamily:p,fontWeight:h,fontColor:l,fontStyle:n,textBaseline:"top"});d.measureText();k.dataSeries.indexLabelsMaxWidth=
...
-t))/2),f.stroke())}}f={source:f,dest:this.plotArea.ctx,animationCallback:H.fadeInAnimation,easingFunction:H.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabelss.length;a++)k=this._indexLabelss[a],d=na("indexLabelsBackgroundColor",k.dataPoint,k.dataSeries),k.dataSeries.indexLabelsBackgroundColor=y(d)?v?"transparent":null:d;return f};q.prototype.renderLine=function(a){var f=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:f;if(!(0>=a.dataSeriesIndexes.length)){var c=
...
S,ca,b);g.push(A);q=R(q);v&&g.push({x:S,y:ca,ctx:c,type:A.type,size:A.size,color:q,borderColor:q,borderThickness:A.borderThickness})}(r[u].indexLabels||k.indexLabels||r[u].indexLabelsFormatter||k.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"line",dataPoint:r[u],dataSeries:k,point:{x:S,y:ca},direction:0>r[u].y===a.axisY.reversed?1:-1,color:w})}b.stroke();v&&c.stroke()}}ja.drawMarkers(g);v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",
...
(p=r[u].lineDashType,b.setLineDash(G(p,k.lineThickness))):(p=k.lineDashType,b.setLineDash(d))));if(0<r[u].markerSize||0<k.markerSize)q=k.getMarkerProperties(u,S,ca,b),g.push(q),A=R(A),v&&g.push({x:S,y:ca,ctx:c,type:q.type,size:q.size,color:A,borderColor:A,borderThickness:q.borderThickness});(r[u].indexLabels||k.indexLabels||r[u].indexLabelsFormatter||k.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stepLine",dataPoint:r[u],dataSeries:k,point:{x:S,y:ca},direction:0>r[u].y===a.axisY.reversed?
...
G(p,k.lineThickness)):(p=k.lineDashType,q[q.length-1].newLineDashArray=d)));if(0<r[D].markerSize||0<k.markerSize){var y=k.getMarkerProperties(D,u,S,c);h.push(y);s=R(s);v&&h.push({x:u,y:S,ctx:e,type:y.type,size:y.size,color:s,borderColor:s,borderThickness:y.borderThickness})}(r[D].indexLabels||k.indexLabels||r[D].indexLabelsFormatter||k.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"spline",dataPoint:r[D],dataSeries:k,point:{x:u,y:S},direction:0>r[D].y===a.axisY.reversed?1:-1,color:w});S=!1}f(q)}ja.drawMarkers(h);
...
0,null,m&&0<=w[g].y,0>w[g].y&&m,!1,!1,d.fillOpacity);c=d.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:h,y1:l,x2:D,y2:u};c=R(c);v&&V(this._eventManager.ghostCtx,h,l,D,u,c,0,null,!1,!1,!1,!1);(w[g].indexLabels||d.indexLabels||w[g].indexLabelsFormatter||d.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"column",dataPoint:w[g],dataSeries:d,point:{x:h+(D-h)/2,y:0>w[g].y===a.axisY.reversed?l:u},direction:0>w[g].y===a.axisY.reversed?
...
!1,D.fillOpacity);c=D.dataPointIds[k];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:k,x1:s,y1:p,x2:y,y2:B};c=R(c);v&&V(this._eventManager.ghostCtx,s,p,y,B,c,0,null,!1,!1,!1,!1);(u[k].indexLabels||D.indexLabels||u[k].indexLabelsFormatter||D.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stackedColumn",dataPoint:u[k],dataSeries:D,point:{x:r,y:0<=u[k].y?p:B},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,B),x2:y,y2:Math.max(p,
...
c=D.dataPointIds[k];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:k,x1:s,y1:p,x2:y,y2:B};c=R(c);v&&V(this._eventManager.ghostCtx,s,p,y,B,c,0,null,!1,!1,!1,!1);(u[k].indexLabels||D.indexLabels||u[k].indexLabelsFormatter||D.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:D,point:{x:r,y:0<=u[k].y?p:B},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,B),x2:y,y2:Math.max(p,B)},color:c})}}v&&
...
V(b,u,l,h,D,c,0,null,m,!1,!1,!1,d.fillOpacity);c=d.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:u,y1:l,x2:h,y2:D};c=R(c);v&&V(this._eventManager.ghostCtx,u,l,h,D,c,0,null,!1,!1,!1,!1);(w[g].indexLabels||d.indexLabels||w[g].indexLabelsFormatter||d.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"bar",dataPoint:w[g],dataSeries:d,point:{x:0<=w[g].y?h:u,y:l+(D-l)/2},direction:0>w[g].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,
...
dataPointIndex:k,x1:B,y1:s,x2:r,y2:y};c=R(c);v&&V(this._eventManager.ghostCtx,B,s,r,y,c,0,null,!1,!1,!1,!1);(u[k].indexLabels||D.indexLabels||u[k].indexLabelsFormatter||D.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:D,point:{x:0<=u[k].y?r:B,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(B,r),y1:s,x2:Math.max(B,r),y2:y},color:c})}}}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",
...
s,y,r,B,c,0,null,!1,!1,!1,!1);(u[k].indexLabels||D.indexLabels||u[k].indexLabelsFormatter||D.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:D,point:{x:0<=u[k].y?r:s,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(s,r),y1:y,x2:Math.max(s,r),y2:B},color:c})}}}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
(0<m[D].markerSize||0<w.markerSize)&&(q=w.getMarkerProperties(D,u,s,g),k.push(q),$=R($),v&&k.push({x:u,y:s,ctx:h,type:q.type,size:q.size,color:$,borderColor:$,borderThickness:q.borderThickness}));(m[D].indexLabels||w.indexLabels||m[D].indexLabelsFormatter||w.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"area",dataPoint:m[D],dataSeries:w,point:{x:u,y:s},direction:0>m[D].y===a.axisY.reversed?1:-1,color:x})}c();ja.drawMarkers(k)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
1].newLineDashArray=G(z,p.lineThickness)):(z=p.lineDashType,q[q.length-1].newLineDashArray=J)));if(0!==n[d].markerSize&&(0<n[d].markerSize||0<p.markerSize)){var da=p.getMarkerProperties(d,w,m,c);l.push(da);I=R(I);v&&l.push({x:w,y:m,ctx:e,type:da.type,size:da.size,color:I,borderColor:I,borderThickness:da.borderThickness})}(n[d].indexLabels||p.indexLabels||n[d].indexLabelsFormatter||p.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"splineArea",dataPoint:n[d],dataSeries:p,point:{x:w,y:m},direction:0>
...
g.setLineDash(G(I,w.lineThickness))):(I=w.lineDashType,g.setLineDash(ea)))),q=w.dataPointIds[D],this._eventManager.objectMap[q]={id:q,objectType:"dataPoint",dataSeriesIndex:d,dataPointIndex:D,x1:u,y1:s},0!==m[D].markerSize&&(0<m[D].markerSize||0<w.markerSize)&&($=w.getMarkerProperties(D,u,s,g),k.push($),q=R(q),v&&k.push({x:u,y:s,ctx:h,type:$.type,size:$.size,color:q,borderColor:q,borderThickness:$.borderThickness})),(m[D].indexLabels||w.indexLabels||m[D].indexLabelsFormatter||w.indexLabelsFormatter)&&
this._indexLabelss.push({chartType:"stepArea",dataPoint:m[D],dataSeries:w,point:{x:u,y:s},direction:0>m[D].y===a.axisY.reversed?1:-1,color:x}))}c();ja.drawMarkers(k)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),g.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&g.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&g.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
A.getMarkerProperties(p,n,d,c),h.push(w),markerColor=R(E),v&&h.push({x:n,y:d,ctx:y,type:w.type,size:w.size,color:markerColor,borderColor:markerColor,borderThickness:w.borderThickness}));($.indexLabels||A.indexLabels||$.indexLabelsFormatter||A.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"stackedArea100",dataPoint:$,dataSeries:A,point:{x:n,y:d},direction:0>z[p].y===a.axisY.reversed?1:-1,color:e})}}f();c.moveTo(n,d);v&&y.moveTo(n,d)}delete A.dataPointIndexes}ja.drawMarkers(h);v&&(b.drawImage(this._preRenderCanvas,
...
dataSeriesIndex:r,dataPointIndex:e,x1:g,y1:h,size:s};s=R(u);v&&ja.drawMarker(g,h,this._eventManager.ghostCtx,d.type,d.size,s,s,d.borderThickness);(n[e].indexLabels||p.indexLabels||n[e].indexLabelsFormatter||p.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"bubble",dataPoint:n[e],dataSeries:p,point:{x:g,y:h},direction:1,bounds:{x1:g-d.size/2,y1:h-d.size/2,x2:g+d.size/2,y2:h+d.size/2},color:null})}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",
...
g)*(p-g)+(n-h)*(n-h))<Math.min(d.size,5)&&r.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:e,x1:g,y1:h},p=R(p),v&&ja.drawMarker(d.x,d.y,this._eventManager.ghostCtx,d.type,d.size,p,p,d.borderThickness),(r[e].indexLabels||k.indexLabels||r[e].indexLabelsFormatter||k.indexLabelsFormatter)&&this._indexLabelss.push({chartType:"scatter",dataPoint:r[e],dataSeries:k,point:{x:g,y:h},direction:1,
...
n)),c.stroke(),c.moveTo(t-z,Math.max(k,n)),c.lineTo(t-z,p),c.stroke(),V(c,x,Math.min(k,n),B,Math.max(k,n),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(b.moveTo(t-z,r),b.lineTo(t-z,p),b.stroke(),b.beginPath(),b.moveTo(t,k),b.lineTo(x,k),b.stroke(),b.beginPath(),b.moveTo(t,n),b.lineTo(B,n),b.stroke(),v&&(e=R(L),c.strokeStyle=e,c.moveTo(t-z,r),c.lineTo(t-z,p),c.stroke(),c.beginPath(),c.moveTo(t,k),c.lineTo(x,k),c.stroke(),c.beginPath(),c.moveTo(t,n),c.lineTo(B,n),c.stroke()));(q[l].indexLabels||u.indexLabels||
q[l].indexLabelsFormatter||u.indexLabelsFormatter)&&this._indexLabelss.push({chartType:u.type,dataPoint:q[l],dataSeries:u,point:{x:x+(B-x)/2,y:a.axisY.reversed?p:r},direction:1,bounds:{x1:x,y1:Math.min(r,p),x2:B,y2:Math.max(r,p)},color:e})}}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
v&&(e=R(M),c.strokeStyle=e,c.lineWidth=oa,0<oa&&(c.moveTo(l-L-E,k),c.lineTo(l-L-E,Math.max(t,p)),c.stroke(),c.moveTo(l-L-E,Math.min(t,p)),c.lineTo(l-L-E,r),c.stroke()),V(c,B,Math.max(k,r),A,Math.min(k,r),e,0,null,!1,!1,!1,!1),0<I&&(c.beginPath(),c.lineWidth=I,c.moveTo(l+ea/2,p-$),c.lineTo(l-ea/2,p-$),c.stroke(),c.moveTo(l+ea/2,t+$),c.lineTo(l-ea/2,t+$),c.stroke()));(x[h].indexLabels||q.indexLabels||x[h].indexLabelsFormatter||q.indexLabelsFormatter)&&this._indexLabelss.push({chartType:q.type,dataPoint:x[h],
...
if(h>l){var u=h;h=l;l=u}u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:g,x1:m,y1:h,x2:q,y2:l};V(b,m,h,q,l,c,0,c,w,w,!1,!1,n.fillOpacity);c=R(u);v&&V(this._eventManager.ghostCtx,m,h,q,l,c,0,null,!1,!1,!1,!1);if(d[g].indexLabels||n.indexLabels||d[g].indexLabelsFormatter||n.indexLabelsFormatter)this._indexLabelss.push({chartType:"rangeColumn",dataPoint:d[g],dataSeries:n,indexKeyword:0,point:{x:m+(q-m)/2,y:d[g].y[1]>=d[g].y[0]?l:h},direction:d[g].y[1]>=
d[g].y[0]?-1:1,bounds:{x1:m,y1:Math.min(h,l),x2:q,y2:Math.max(h,l)},color:c}),this._indexLabelss.push({chartType:"rangeColumn",dataPoint:d[g],dataSeries:n,indexKeyword:1,point:{x:m+(q-m)/2,y:d[g].y[1]>=d[g].y[0]?h:l},direction:d[g].y[1]>=d[g].y[0]?1:-1,bounds:{x1:m,y1:Math.min(h,l),x2:q,y2:Math.max(h,l)},color:c})}}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
2-(A?C-1:0)*u<<0:t-(A?q:1)*u/2+(A?C-1:0)*u<<0,p=a.axisX.reversed?r-u<<0:r+u<<0);!c&&n>d&&(da=n,n=d,d=da);c&&r>p&&(da=r,r=p,p=da);da=ba.dataPointIds[l];this._eventManager.objectMap[da]={id:da,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:l,x1:Math.min(r,p),y1:Math.min(n,d),x2:Math.max(p,r),y2:Math.max(d,n),isXYSwapped:c,stemProperties:I,whiskerProperties:J};z(b,Math.min(r,p),Math.min(n,d),Math.max(p,r),Math.max(d,n),e,J,I,c);v&&z(this._eventManager.ghostCtx,r,n,p,d,e,J,I,c);if(B[l].indexLabels||
ba.indexLabels||B[l].indexLabelsFormatter||ba.indexLabelsFormatter)this._indexLabelss.push({chartType:"error",dataPoint:B[l],dataSeries:ba,indexKeyword:0,point:{x:c?B[l].y[1]>=B[l].y[0]?r:p:r+(p-r)/2,y:c?n+(d-n)/2:B[l].y[1]>=B[l].y[0]?d:n},direction:B[l].y[1]>=B[l].y[0]?-1:1,bounds:{x1:c?Math.min(r,p):r,y1:c?n:Math.min(n,d),x2:c?Math.max(r,p):p,y2:c?d:Math.max(n,d)},color:e,axisSwapped:c}),this._indexLabelss.push({chartType:"error",dataPoint:B[l],dataSeries:ba,indexKeyword:1,point:{x:c?B[l].y[1]>=B[l].y[0]?
...
r/2+(a.previousDataSeriesCount+p)*r<<0;var q=a.axisX.reversed?t-r<<0:t+r<<0;h>l&&(c=h,h=l,l=c);c=w[g].color?w[g].color:d._colorSet[g%d._colorSet.length];V(b,h,t,l,q,c,0,null,m,!1,!1,!1,d.fillOpacity);c=d.dataPointIds[g];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:g,x1:h,y1:t,x2:l,y2:q};c=R(c);v&&V(this._eventManager.ghostCtx,h,t,l,q,c,0,null,!1,!1,!1,!1);if(w[g].indexLabels||d.indexLabels||w[g].indexLabelsFormatter||d.indexLabelsFormatter)this._indexLabelss.push({chartType:"rangeBar",
dataPoint:w[g],dataSeries:d,indexKeyword:0,point:{x:w[g].y[1]>=w[g].y[0]?h:l,y:t+(q-t)/2},direction:w[g].y[1]>=w[g].y[0]?-1:1,bounds:{x1:Math.min(h,l),y1:t,x2:Math.max(h,l),y2:q},color:c}),this._indexLabelss.push({chartType:"rangeBar",dataPoint:w[g],dataSeries:d,indexKeyword:1,point:{x:w[g].y[1]>=w[g].y[0]?l:h,y:t+(q-t)/2},direction:w[g].y[1]>=w[g].y[0]?1:-1,bounds:{x1:Math.min(h,l),y1:t,x2:Math.max(h,l),y2:q},color:c})}}}v&&(f.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
1].newLineDashArray=C,c.setLineDash(C))));if(0!==p[d].markerSize&&(0<p[d].markerSize||0<r.markerSize)){var I=r.getMarkerProperties(d,w,q,c);g.push(I);var da=R(u);v&&g.push({x:w,y:q,ctx:e,type:I.type,size:I.size,color:da,borderColor:da,borderThickness:I.borderThickness});I=r.getMarkerProperties(d,w,m,c);g.push(I);da=R(u);v&&g.push({x:w,y:m,ctx:e,type:I.type,size:I.size,color:da,borderColor:da,borderThickness:I.borderThickness})}if(p[d].indexLabels||r.indexLabels||p[d].indexLabelsFormatter||r.indexLabelsFormatter)this._indexLabelss.push({chartType:"rangeArea",
dataPoint:p[d],dataSeries:r,indexKeyword:0,point:{x:w,y:m},direction:p[d].y[0]>p[d].y[1]===a.axisY.reversed?-1:1,color:y}),this._indexLabelss.push({chartType:"rangeArea",dataPoint:p[d],dataSeries:r,indexKeyword:1,point:{x:w,y:q},direction:p[d].y[0]>p[d].y[1]===a.axisY.reversed?1:-1,color:y})}else J||n||f(),J=!0;f();ja.drawMarkers(g)}}v&&(b.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
r[p].markerSize||0<k.markerSize)){var L=k.getMarkerProperties(p,n,d,c);g.push(L);var J=R(C);v&&g.push({x:n,y:d,ctx:e,type:L.type,size:L.size,color:J,borderColor:J,borderThickness:L.borderThickness});L=k.getMarkerProperties(p,n,w,c);g.push(L);J=R(C);v&&g.push({x:n,y:w,ctx:e,type:L.type,size:L.size,color:J,borderColor:J,borderThickness:L.borderThickness})}if(r[p].indexLabels||k.indexLabels||r[p].indexLabelsFormatter||k.indexLabelsFormatter)this._indexLabelss.push({chartType:"rangeSplineArea",dataPoint:r[p],
dataSeries:k,indexKeyword:0,point:{x:n,y:d},direction:r[p].y[0]<=r[p].y[1]?-1:1,color:u}),this._indexLabelss.push({chartType:"rangeSplineArea",dataPoint:r[p],dataSeries:k,indexKeyword:1,point:{x:n,y:w},direction:r[p].y[0]<=r[p].y[1]?1:-1,color:u});d=!1}else 0<p&&!d&&(k.connectNullData?c.setLineDash&&(0<m.length&&(k.options.nullDataLineDashType||!r[p-1].lineDashType))&&(m[m.length-1].newLineDashArray=A,z=k.nullDataLineDashType):(f(B,s),m=[],q=[])),d=!0;f(B,s);ja.drawMarkers(g)}}v&&(b.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());c.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:H.xClipAnimation,easingFunction:H.easing.linear,
...
{percent:null,total:null},m=null,p=t.getPercentAndTotal(k,g);if(k.indexLabelsFormatter||g.indexLabelsFormatter)m={chart:t.options,dataSeries:k,dataPoint:g,total:p.total,percent:p.percent};p=g.indexLabelsFormatter?g.indexLabelsFormatter(m):g.indexLabels?t.replaceKeywordsWithValue(g.indexLabels,g,k,f):k.indexLabelsFormatter?k.indexLabelsFormatter(m):k.indexLabels?t.replaceKeywordsWithValue(k.indexLabels,g,k,f):g.label?g.label:"";t._eventManager.objectMap[h]=l;l.center={x:x.x,y:x.y};l.y=g.y;l.radius=A;l.percentInnerRadius=
L;l.indexLabelsText=p;l.indexLabelsPlacement=k.indexLabelsPlacement;l.indexLabelsLineColor=g.indexLabelsLineColor?g.indexLabelsLineColor:k.options.indexLabelsLineColor?k.options.indexLabelsLineColor:g.color?g.color:k._colorSet[f%k._colorSet.length];l.indexLabelsLineThickness=y(g.indexLabelsLineThickness)?k.indexLabelsLineThickness:g.indexLabelsLineThickness;l.indexLabelsLineDashType=g.indexLabelsLineDashType?g.indexLabelsLineDashType:k.indexLabelsLineDashType;l.indexLabelsFontColor=g.indexLabelsFontColor?g.indexLabelsFontColor:
k.indexLabelsFontColor;l.indexLabelsFontStyle=g.indexLabelsFontStyle?g.indexLabelsFontStyle:k.indexLabelsFontStyle;l.indexLabelsFontWeight=g.indexLabelsFontWeight?g.indexLabelsFontWeight:k.indexLabelsFontWeight;l.indexLabelsFontSize=y(g.indexLabelsFontSize)?k.indexLabelsFontSize:g.indexLabelsFontSize;l.indexLabelsFontFamily=g.indexLabelsFontFamily?g.indexLabelsFontFamily:k.indexLabelsFontFamily;l.indexLabelsBackgroundColor=g.indexLabelsBackgroundColor?g.indexLabelsBackgroundColor:k.options.indexLabelsBackgroundColor?
k.options.indexLabelsBackgroundColor:k.indexLabelsBackgroundColor;l.indexLabelsMaxWidth=g.indexLabelsMaxWidth?g.indexLabelsMaxWidth:k.indexLabelsMaxWidth?k.indexLabelsMaxWidth:0.33*n.width;l.indexLabelsWrap="undefined"!==typeof g.indexLabelsWrap?g.indexLabelsWrap:k.indexLabelsWrap;l.startAngle=0===f?k.startAngle?k.startAngle/180*Math.PI:0:d[f-1].endAngle;l.startAngle=(l.startAngle+2*Math.PI)%(2*Math.PI);l.endAngle=l.startAngle+2*Math.PI/z*Math.abs(g.y);g=(l.endAngle+l.startAngle)/2;g=(g+2*Math.PI)%(2*Math.PI);
l.midAngle=g;if(l.midAngle>Math.PI/2-u&&l.midAngle<Math.PI/2+u){if(0===a||d[c].midAngle>l.midAngle)c=f;a++}else if(l.midAngle>3*Math.PI/2-u&&l.midAngle<3*Math.PI/2+u){if(0===b||d[e].midAngle>l.midAngle)e=f;b++}l.hemisphere=g>Math.PI/2&&g<=3*Math.PI/2?"left":"right";l.indexLabelsTextBlock=new la(t.plotArea.ctx,{fontSize:l.indexLabelsFontSize,fontFamily:l.indexLabelsFontFamily,fontColor:l.indexLabelsFontColor,fontStyle:l.indexLabelsFontStyle,fontWeight:l.indexLabelsFontWeight,horizontalAlign:"left",backgroundColor:l.indexLabelsBackgroundColor,
maxWidth:l.indexLabelsMaxWidth,maxHeight:l.indexLabelsWrap?5*l.indexLabelsFontSize:1.5*l.indexLabelsFontSize,text:l.indexLabelsText,padding:0,textBaseline:"top"});l.indexLabelsTextBlock.measureText()}h=g=0;p=!1;for(f=0;f<r.length;f++)l=d[(c+f)%r.length],1<a&&(l.midAngle>Math.PI/2-u&&l.midAngle<Math.PI/2+u)&&(g<=a/2&&!p?(l.hemisphere="right",g++):(l.hemisphere="left",p=!0));p=!1;for(f=0;f<r.length;f++)l=d[(e+f)%r.length],1<b&&(l.midAngle>3*Math.PI/2-u&&l.midAngle<3*Math.PI/2+u)&&(h<=b/2&&!p?(l.hemisphere=
...
x.x)||0<Math.abs(d[b].center.y-x.y))d[b].center.x=x.x+f*(1-a),d[b].center.y=x.y+g*(1-a),h=!0;h&&(f={},f.dataSeries=k,f.dataPoint=k.dataPoints[b],f.index=b,t.toolTip.highlightObjects([f]));ra(t.plotArea.ctx,d[b].center,d[b].radius,r[b].color?r[b].color:k._colorSet[b%k._colorSet.length],k.type,c,e,k.fillOpacity,d[b].percentInnerRadius)}}a=t.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<r.length;b++)c=d[b],c.indexLabelsText&&(c.indexLabelsTextBlock.y-=
c.indexLabelsTextBlock.height/2,e=0,e="left"===c.hemisphere?"inside"!==k.indexLabelsPlacement?-(c.indexLabelsTextBlock.width+p):-c.indexLabelsTextBlock.width/2:"inside"!==k.indexLabelsPlacement?p:-c.indexLabelsTextBlock.width/2,c.indexLabelsTextBlock.x+=e,c.indexLabelsTextBlock.render(!0),c.indexLabelsTextBlock.x-=e,c.indexLabelsTextBlock.y+=c.indexLabelsTextBlock.height/2,"inside"!==c.indexLabelsPlacement&&0<c.indexLabelsLineThickness&&(e=c.center.x+A*Math.cos(c.midAngle),f=c.center.y+A*Math.sin(c.midAngle),
a.strokeStyle=c.indexLabelsLineColor,a.lineWidth=c.indexLabelsLineThickness,a.setLineDash&&a.setLineDash(G(c.indexLabelsLineDashType,c.indexLabelsLineThickness)),a.beginPath(),a.moveTo(e,f),a.lineTo(c.indexLabelsTextBlock.x,c.indexLabelsTextBlock.y),a.lineTo(c.indexLabelsTextBlock.x+("left"===c.hemisphere?-p:p),c.indexLabelsTextBlock.y),a.stroke()),a.lineJoin="miter");a.save()}function c(a,b){var c=0,c=a.indexLabelsTextBlock.y-a.indexLabelsTextBlock.height/2,d=a.indexLabelsTextBlock.y+a.indexLabelsTextBlock.height/
2,e=b.indexLabelsTextBlock.y-b.indexLabelsTextBlock.height/2,f=b.indexLabelsTextBlock.y+b.indexLabelsTextBlock.height/2;return c=b.indexLabelsTextBlock.y>a.indexLabelsTextBlock.y?e-d:c-f}function e(a){for(var b=null,e=1;e<r.length;e++)if(b=(a+e+d.length)%d.length,d[b].hemisphere!==d[a].hemisphere){b=null;break}else if(d[b].indexLabelsText&&b!==a&&(0>c(d[b],d[a])||("right"===d[a].hemisphere?d[b].indexLabelsTextBlock.y>=d[a].indexLabelsTextBlock.y:d[b].indexLabelsTextBlock.y<=d[a].indexLabelsTextBlock.y)))break;
else b=null;return b}function g(a,b,f){f=(f||0)+1;if(1E3<f)return 0;b=b||0;var k=0,h=x.y-1*q,n=x.y+1*q;if(0<=a&&a<r.length){var l=d[a];if(0>b&&l.indexLabelsTextBlock.y<h||0<b&&l.indexLabelsTextBlock.y>n)return 0;var t=0,p=0,p=t=t=0;0>b?l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2>h&&l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2+b<h&&(b=-(h-(l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2+b))):l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2<h&&l.indexLabelsTextBlock.y+
l.indexLabelsTextBlock.height/2+b>n&&(b=l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2+b-n);b=l.indexLabelsTextBlock.y+b;h=0;h="right"===l.hemisphere?x.x+Math.sqrt(Math.pow(q,2)-Math.pow(b-x.y,2)):x.x-Math.sqrt(Math.pow(q,2)-Math.pow(b-x.y,2));p=x.x+A*Math.cos(l.midAngle);t=x.y+A*Math.sin(l.midAngle);t=Math.sqrt(Math.pow(h-p,2)+Math.pow(b-t,2));p=Math.acos(A/q);t=Math.acos((q*q+A*A-t*t)/(2*A*q));b=t<p?b-l.indexLabelsTextBlock.y:0;h=null;for(n=1;n<r.length;n++)if(h=(a-n+d.length)%d.length,d[h].hemisphere!==
d[a].hemisphere){h=null;break}else if(d[h].indexLabelsText&&d[h].hemisphere===d[a].hemisphere&&h!==a&&(0>c(d[h],d[a])||("right"===d[a].hemisphere?d[h].indexLabelsTextBlock.y<=d[a].indexLabelsTextBlock.y:d[h].indexLabelsTextBlock.y>=d[a].indexLabelsTextBlock.y)))break;else h=null;p=h;t=e(a);n=h=0;0>b?(n="right"===l.hemisphere?p:t,k=b,null!==n&&(p=-b,b=l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2-(d[n].indexLabelsTextBlock.y+d[n].indexLabelsTextBlock.height/2),b-p<m&&(h=-p,n=g(n,h,f+1),+n.toFixed(v)>
+h.toFixed(v)&&(k=b>m?-(b-m):-(p-(n-h)))))):0<b&&(n="right"===l.hemisphere?t:p,k=b,null!==n&&(p=b,b=d[n].indexLabelsTextBlock.y-d[n].indexLabelsTextBlock.height/2-(l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2),b-p<m&&(h=p,n=g(n,h,f+1),+n.toFixed(v)<+h.toFixed(v)&&(k=b>m?b-m:p-(h-n)))));k&&(f=l.indexLabelsTextBlock.y+k,b=0,b="right"===l.hemisphere?x.x+Math.sqrt(Math.pow(q,2)-Math.pow(f-x.y,2)):x.x-Math.sqrt(Math.pow(q,2)-Math.pow(f-x.y,2)),l.midAngle>Math.PI/2-u&&l.midAngle<Math.PI/2+u?(h=(a-
1+d.length)%d.length,h=d[h],a=d[(a+1+d.length)%d.length],"left"===l.hemisphere&&"right"===h.hemisphere&&b>h.indexLabelsTextBlock.x?b=h.indexLabelsTextBlock.x-15:"right"===l.hemisphere&&("left"===a.hemisphere&&b<a.indexLabelsTextBlock.x)&&(b=a.indexLabelsTextBlock.x+15)):l.midAngle>3*Math.PI/2-u&&l.midAngle<3*Math.PI/2+u&&(h=(a-1+d.length)%d.length,h=d[h],a=d[(a+1+d.length)%d.length],"right"===l.hemisphere&&"left"===h.hemisphere&&b<h.indexLabelsTextBlock.x?b=h.indexLabelsTextBlock.x+15:"left"===l.hemisphere&&
("right"===a.hemisphere&&b>a.indexLabelsTextBlock.x)&&(b=a.indexLabelsTextBlock.x-15)),l.indexLabelsTextBlock.y=f,l.indexLabelsTextBlock.x=b,l.indexLabelsAngle=Math.atan2(l.indexLabelsTextBlock.y-x.y,l.indexLabelsTextBlock.x-x.x))}return k}function h(){var a=t.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var b=a=0,f=0,h=!0,b=0;10>b&&(1>b||0<f);b++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&A-f<=C)h=!1;h&&(A-=
f);f=0;if("inside"!==k.indexLabelsPlacement){q=A*s;for(a=0;a<r.length;a++){var l=d[a];l.indexLabelsTextBlock.x=x.x+q*Math.cos(l.midAngle);l.indexLabelsTextBlock.y=x.y+q*Math.sin(l.midAngle);l.indexLabelsAngle=l.midAngle;l.radius=A;l.percentInnerRadius=L}for(var u,y,a=0;a<r.length;a++){var l=d[a],B=e(a);if(null!==B){u=d[a];y=d[B];var z=0,z=c(u,y)-m;if(0>z){for(var ba=y=0,G=0;G<r.length;G++)G!==a&&d[G].hemisphere===l.hemisphere&&(d[G].indexLabelsTextBlock.y<l.indexLabelsTextBlock.y?y++:ba++);y=z/(y+ba||1)*
ba;var ba=-1*(z-y),H=G=0;"right"===l.hemisphere?(G=g(a,y),ba=-1*(z-G),H=g(B,ba),+H.toFixed(v)<+ba.toFixed(v)&&+G.toFixed(v)<=+y.toFixed(v)&&g(a,-(ba-H))):(G=g(B,y),ba=-1*(z-G),H=g(a,ba),+H.toFixed(v)<+ba.toFixed(v)&&+G.toFixed(v)<=+y.toFixed(v)&&g(B,-(ba-H)))}}}}else for(a=0;a<r.length;a++)l=d[a],q="pie"===k.type?0.7*A:0.8*A,B=x.x+q*Math.cos(l.midAngle),y=x.y+q*Math.sin(l.midAngle),l.indexLabelsTextBlock.x=B,l.indexLabelsTextBlock.y=y;for(a=0;a<r.length;a++)if(l=d[a],B=l.indexLabelsTextBlock.measureText(),
0!==B.height&&0!==B.width)B=B=0,"right"===l.hemisphere?(B=n.x2-(l.indexLabelsTextBlock.x+l.indexLabelsTextBlock.width+p),B*=-1):B=n.x1-(l.indexLabelsTextBlock.x-l.indexLabelsTextBlock.width-p),0<B&&(!h&&l.indexLabelsText&&(y="right"===l.hemisphere?n.x2-l.indexLabelsTextBlock.x:l.indexLabelsTextBlock.x-n.x1,0.3*l.indexLabelsTextBlock.maxWidth>y?l.indexLabelsText="":l.indexLabelsTextBlock.maxWidth=0.85*y,0.3*l.indexLabelsTextBlock.maxWidth<y&&(l.indexLabelsTextBlock.x-="right"===l.hemisphere?2:-2)),Math.abs(l.indexLabelsTextBlock.y-
l.indexLabelsTextBlock.height/2-x.y)<A||Math.abs(l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2-x.y)<A)&&(B/=Math.abs(Math.cos(l.indexLabelsAngle)),9<B&&(B*=0.3),B>f&&(f=B)),B=B=0,0<l.indexLabelsAngle&&l.indexLabelsAngle<Math.PI?(B=n.y2-(l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2+5),B*=-1):B=n.y1-(l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2-5),0<B&&(!h&&l.indexLabelsText&&(y=0<l.indexLabelsAngle&&l.indexLabelsAngle<Math.PI?-1:1,0===g(a,B*y)&&g(a,2*y)),Math.abs(l.indexLabelsTextBlock.x-
x.x)<A&&(B/=Math.abs(Math.sin(l.indexLabelsAngle)),9<B&&(B*=0.3),B>f&&(f=B)));var K=function(a,b,c){for(var e=[],f=0;e.push(d[b]),b!==c;b=(b+1+r.length)%r.length);e.sort(function(a,b){return a.y-b.y});for(b=0;b<e.length;b++)if(c=e[b],f<0.7*a)f+=c.indexLabelsTextBlock.height,c.indexLabelsTextBlock.text="",c.indexLabelsText="",c.indexLabelsTextBlock.measureText();else break};(function(){for(var a=-1,b=-1,f=0,g=!1,h=0;h<r.length;h++)if(g=!1,u=d[h],u.indexLabelsText){var k=e(h);if(null!==k){var l=d[k];z=0;
z=c(u,l);var n;if(n=0>z){n=u.indexLabelsTextBlock.x;var t=u.indexLabelsTextBlock.y-u.indexLabelsTextBlock.height/2,m=u.indexLabelsTextBlock.y+u.indexLabelsTextBlock.height/2,w=l.indexLabelsTextBlock.y-l.indexLabelsTextBlock.height/2,q=l.indexLabelsTextBlock.x+l.indexLabelsTextBlock.width,s=l.indexLabelsTextBlock.y+l.indexLabelsTextBlock.height/2;n=u.indexLabelsTextBlock.x+u.indexLabelsTextBlock.width<l.indexLabelsTextBlock.x-p||n>q+p||t>s+p||m<w-p?!1:!0}n?(0>a&&(a=h),k!==a&&(b=k,f+=-z),0===h%Math.max(r.length/
...
u.reversed?x[za]:x[z];a=b.color?b.color:u.reversed?u._colorSet[(x.length-1-z)%u._colorSet.length]:u._colorSet[z%u._colorSet.length];c=b.indexLabelsPlacement||u.indexLabelsPlacement||"outside";e=b.indexLabelsBackgroundColor||u.indexLabelsBackgroundColor||(v?"transparent":null);f=b.indexLabelsFontColor||u.indexLabelsFontColor||"#979797";g=y(b.indexLabelsFontSize)?u.indexLabelsFontSize:b.indexLabelsFontSize;h=b.indexLabelsFontStyle||u.indexLabelsFontStyle||"normal";k=b.indexLabelsFontFamily||u.indexLabelsFontFamily||
"arial";l=b.indexLabelsFontWeight||u.indexLabelsFontWeight||"normal";a=b.indexLabelsLineColor||u.options.indexLabelsLineColor||a;n="number"===typeof b.indexLabelsLineThickness?b.indexLabelsLineThickness:"number"===typeof u.indexLabelsLineThickness?u.indexLabelsLineThickness:2;t=b.indexLabelsLineDashType||u.indexLabelsLineDashType||"solid";p="undefined"!==typeof b.indexLabelsWrap?b.indexLabelsWrap:"undefined"!==typeof u.indexLabelsWrap?u.indexLabelsWrap:!0;r=u.dataPointIds[z];s._eventManager.objectMap[r]={id:r,
objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:M[u.reversed?x.length-1-z:z]};"inside"===u.indexLabelsPlacement&&(w[z]=z!==ga?u.reversed?M[z].x2-M[z].x1:M[z].x3-M[z].x4:M[z].x3-M[z].x6,20>w[z]&&(w[z]=z!==ga?u.reversed?M[z].x3-M[z].x4:M[z].x2-M[z].x1:M[z].x2-M[z].x1,w[z]/=2));r=b.indexLabelsMaxWidth?b.indexLabelsMaxWidth:u.options.indexLabelsMaxWidth?u.indexLabelsMaxWidth:w[z];if(r>w[z]||0>r)r=w[z];q[z]="inside"===u.indexLabelsPlacement?M[z].height:!1;A=s.getPercentAndTotal(u,b);
if(u.indexLabelsFormatter||b.indexLabelsFormatter)B={chart:s.options,dataSeries:u,dataPoint:b,total:A.total,percent:A.percent};b=b.indexLabelsFormatter?b.indexLabelsFormatter(B):b.indexLabels?s.replaceKeywordsWithValue(b.indexLabels,b,u,z):u.indexLabelsFormatter?u.indexLabelsFormatter(B):u.indexLabels?s.replaceKeywordsWithValue(u.indexLabels,b,u,z):b.label?b.label:"";0>=n&&(n=0);1E3>r&&1E3-r<m&&(r+=1E3-r);R.roundRect||Ca(R);c=new la(R,{fontSize:g,fontFamily:k,fontColor:f,fontStyle:h,fontWeight:l,horizontalAlign:c,
backgroundColor:e,maxWidth:r,maxHeight:!1===q[z]?p?4.28571429*g:1.5*g:q[z],text:b,padding:ha});c.measureText();F.push({textBlock:c,id:u.reversed?za:z,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:t,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g=P-V-U/2,g=u.options.indexLabelsMaxWidth?u.indexLabelsMaxWidth>g?g:u.indexLabelsMaxWidth:g,h=F.length-1;0<=h;h--){dataPoint=x[F[h].id];c=F[h];d=c.textBlock;
b=(a=n(h)<M.length?F[n(h)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ha>b.y&&(e=!0);c=dataPoint.indexLabelsMaxWidth||g;if(c>g||0>c)c=g;f.push(c)}if(e)for(h=F.length-1;0<=h;h--)a=M[h],F[h].textBlock.maxWidth=f[f.length-(h+1)],F[h].textBlock.measureText(),F[h].textBlock.x=P-g,c=F[h].textBlock.height<F[h].textBlock.maxHeight?F[h].textBlock.height:F[h].textBlock.maxHeight,e=F[h].textBlock.width<F[h].textBlock.maxWidth?F[h].textBlock.width:F[h].textBlock.maxWidth,F[h].height=c,F[h].width=e,c="undefined"!==
typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,F[h].textBlock.y=c-F[h].height/2,u.reversed?(F[h].textBlock.y+F[h].height>T+C&&(F[h].textBlock.y=T+C-F[h].height),F[h].textBlock.y<ta-C&&(F[h].textBlock.y=ta-C)):(F[h].textBlock.y<T-C&&(F[h].textBlock.y=T-C),F[h].textBlock.y+F[h].height>ta+C&&(F[h].textBlock.y=ta+C-F[h].height))}function g(){var a,b,c,e;if("inside"!==u.indexLabelsPlacement)for(var f=0;f<M.length;f++)0==F[f].textBlock.text.length?F[f].isDirty=!0:(a=M[f],c="undefined"!==typeof a.x5?(a.y2+a.y4)/
...
x3:Y,y3:aa,x4:B[E+1],y4:L[E+1],x5:a[E+1],y5:L[E+1],x6:K,y6:aa,id:E,height:L[E+1]-L[E],color:W}):M.push({x1:a[E],y1:L[E],x2:B[E],y2:L[E],x3:B[E+1],y3:L[E+1],x4:a[E+1],y4:L[E+1],id:E,height:L[E+1]-L[E],color:W});var ha=2,F=[],ja=!1,ma=[],ka=[],I=!1;a=a=0;Da(ma);for(E=0;E<x.length;E++)x[E].exploded&&(I=!0,u.reversed?ma.push(x.length-1-E):ma.push(E));R.clearRect(z.x1,z.y1,z.width,z.height);R.fillStyle=s.backgroundColor;R.fillRect(z.x1,z.y1,z.width,z.height);if(J&&u.visible&&(c(),g(),e(),"inside"!==u.indexLabelsPlacement)){h();
for(E=0;E<x.length;E++)F[E].isDirty||(a=F[E].textBlock.x+F[E].width,a=(P-a)/2,0==E&&(A=a),A>a&&(A=a));for(E=0;E<M.length;E++)M[E].x1+=A,M[E].x2+=A,M[E].x3+=A,M[E].x4+=A,M[E].x5&&(M[E].x5+=A,M[E].x6+=A),F[E].textBlock.x+=A}for(E=0;E<M.length;E++)A=M[E],sa(R,A,u.fillOpacity),ka.push(A.y1);q(R);J&&u.visible&&("inside"===u.indexLabelsPlacement||s.animationEnabled||r(R),s.animationEnabled||m());if(!J)for(E=0;E<x.length;E++)A=u.dataPointIds[E],a={id:A,objectType:"dataPoint",dataPointIndex:E,dataSeriesIndex:0,
