...
var ws,b,rnd,spot,time,dps,xd,digit,cnt,x,random,id,lng,str,chart,xVal,yVal,yVal2,checkBack,mType,mColor,rndMenu,tic,tic2,HdCol,spotArr;

str=["R_100","R_10","R_25","R_50","R_75","RDBEAR","RDBULL","1HZ100V","1HZ10V","1HZ25V","1HZ50V","1HZ75V"];HdClss=[]; HdCol=[]; spotArr=[0]; dps=[]; time=[0]; spot=[0]; tic=[];tic2=[];digit=[0]; mType="none"; mColor="#32cd32"; lng="EN"; xVal=0; yVal=0; x=0; yVal2=0; checkBack = 0; cnt=40;
...
var tic = new Array(20);
 ...
 var checkbox = document.getElementById("DigigDisp");
checkbox.addEventListener('change', function() {
  if (this.checked) {
    document.getElementById("WormTXT").textContent ='Worm' ; 
  } else {
    document.getElementById("WormTXT").textContent = 'Digit' 
...
ws.onmessage = function(msg) {
  ...
  if (b.history) {
    ...
    for(var i=0; i<20+1; i++){
        ...
        var checkDigigDisp = document.getElementById("DigigDisp");
        var showDigit = "";
        if (checkDigigDisp.checked == true) {
           showDigit = DigitLbl;
        }else if (checkDigigDisp.checked == false) {
           showDigit = "";
        }
